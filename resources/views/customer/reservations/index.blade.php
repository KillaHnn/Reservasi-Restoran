                ...
                <div class="col-lg-4">
                    <div class="card card-custom border-0 shadow-sm p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="reservation_date" class="form-control bg-light border-0 p-3"
                        ...
                        <div class="row">
                            <div class="col-6 mb-3">
                                ...
                                <input type="time" name="start_time" class="form-control bg-light border-0 p-3"
                                    value="18:00" required>
                            </div>
                            <div class="col-6 mb-3">
                                <label class="small fw-bold mb-2">END TIME</label>
                                <input type="time" name="end_time" class="form-control bg-light border-0 p-3"
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="guest_count" class="form-control bg-light border-0 p-3"
                                    placeholder="How many people?" min="1" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="special_note" class="form-control bg-light border-0 p-3" rows="3"
                                placeholder="Eg: Birthday celebration..."></textarea>
                        </div>
                        ...
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label small" for="agreeTerms">
                                I agree to the <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal"
                                    class="text-decoration-none fw-bold" style="color: var(--primary)">Terms &
                                    Conditions</a>
                            </label>
                        </div>
                    ...
                    <div class="card card-custom border-0 shadow-sm p-4 h-100">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <span class="badge bg-success-subtle text-success px-3">
                                {{ $tables->where('status', 'active')->count() }} Tables Available
                            </span>
                        </div>
                            ...
                            @foreach ($tables as $table)
                                ...
                                <div class="col-md-4 col-6">
                                    <input type="radio" class="btn-check" name="table_id" id="table{{ $table->id }}"
                                        autocomplete="off" value="{{ $table->id }}" {{ $isBooked ? 'disabled' : '' }}
                                        required>

                                    <label
                                        class="btn w-100 p-4 border-0 shadow-sm table-card {{ $isBooked ? 'booked-style' : 'available-style' }}"
                                        for="table{{ $table->id }}">

                                        <i
                                            class="fas {{ $isBooked ? 'fa-calendar-check' : 'fa-utensils' }} mb-3 d-block fa-2x"></i>

                                        <span class="d-block fw-bold">{{ $table->name ?? 'Table ' . $table->id }}</span>
                                        <small class="d-block">{{ $table->capacity }} Seats</small>
